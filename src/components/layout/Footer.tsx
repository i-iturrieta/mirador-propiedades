...
export function Footer() {
  ...
  return (
    /* Sin margen superior a propósito: cada página cierra con su propio
       padding. Un `mt` aquí abría una franja blanca entre el CTA oscuro del
       home y el footer, que también es oscuro. */
